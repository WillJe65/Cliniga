...
import { Home, Calendar, Users, FileText, Settings, LogOut, Activity, Clock, UserCircle } from 'lucide-react';
...
const DoctorSidebar = () => {
  ...
  const menuItems = [
    { icon: Home, label: 'Dashboard', href: '/doctor-dashboard', active: location === '/doctor-dashboard' },
    { icon: Calendar, label: 'Daftar Appointment', href: '/doctor-appointments', active: location === '/doctor-appointments' },
    { icon: Users, label: 'Appointment Masuk', href: '/doctor-incoming-appointments', active: location === '/doctor-incoming-appointments' },
    { icon: UserCircle, label: 'Profil Account', href: '/doctor-profile', active: location === '/doctor-profile' },
    { icon: Settings, label: 'Pengaturan', href: '/doctor-settings', active: location === '/doctor-settings' },
  ];
    ...
    <div className="w-72 h-screen bg-white border-r border-slate-200 flex flex-col fixed left-0 top-0 z-50">
      ...
      <div className="p-4 border-t border-slate-100">
        <button 
          ...
          className="w-full flex items-center justify-center space-x-2 px-4 py-3 text-red-600 hover:bg-red-50 rounded-xl transition-all font-medium text-sm group"
        >
