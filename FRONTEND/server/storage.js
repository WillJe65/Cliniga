...
export class MemStorage {
  ...
  seedData() {
    const doctorUsers = [
      { id: "doc-user-1", email: "dr.smith@cliniga.com", password: "password123", name: "Sarah Smith", role: "doctor" },
      { id: "doc-user-2", email: "dr.johnson@cliniga.com", password: "password123", name: "Michael Johnson", role: "doctor" },
      { id: "doc-user-3", email: "dr.williams@cliniga.com", password: "password123", name: "Emily Williams", role: "doctor" },
      { id: "doc-user-4", email: "dr.brown@cliniga.com", password: "password123", name: "James Brown", role: "doctor" },
      { id: "doc-user-5", email: "dr.davis@cliniga.com", password: "password123", name: "Jennifer Davis", role: "doctor" },
      { id: "doc-user-6", email: "dr.miller@cliniga.com", password: "password123", name: "Robert Miller", role: "doctor" },
    ];
