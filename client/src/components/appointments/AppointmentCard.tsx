...
export function AppointmentCard({
  ...
  const displayName =
    viewType === "patient" ? appointment.doctorName : appointment.patientName;
  const displayRole =
    viewType === "patient" ? appointment.specialization : "Patient";
            ...
            <div className="min-w-0 flex-1 space-y-1">
              <div className="flex flex-wrap items-center gap-2">
                <h3
                  ...
                  data-testid={`text-name-${appointment.id}`}
                >
                  {viewType === "patient" ? "Dr. " : ""}
                  {displayName}
                </h3>
              ...
              <div className="flex flex-wrap items-center gap-4 pt-1 text-sm text-muted-foreground">
                <span
                  ...
                  data-testid={`text-date-${appointment.id}`}
                >
            ...
            {viewType === "doctor" &&
              ...
              !isAppointmentPast() && (
                <Button
                  ...
                  onClick={onAddRecord}
                  className="gap-1.5"
                  data-testid={`button-add-record-${appointment.id}`}
                >
