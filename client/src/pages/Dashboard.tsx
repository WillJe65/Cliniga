...
export default function Dashboard() {
  ...
  const appointments = allAppointments.filter((apt) => {
    ...
    // For doctors, match by doctor name since seeded doctors have different IDs
    if (user?.role === "doctor") {
  ...
  const handleAddRecord = (appointment: Appointment) => {
    setSelectedAppointment(appointment);
    setRecordModalOpen(true);
  };

  const handleSaveRecord = async (diagnosis: string, notes: string) => {
